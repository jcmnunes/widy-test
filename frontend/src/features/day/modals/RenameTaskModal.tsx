...
import { UpdateTaskVariables, useUpdateTask } from '../api/useUpdateTask';
...
export const RenameTaskModal: React.FC<Props> = ({
  dayId,
  sectionId,
  taskData,
  onRequestClose,
  ...
  const formik = useFormik({
    ...
    validationSchema,
    onSubmit: ({ title }) => {
      const updateTaskVariables: UpdateTaskVariables = {
        taskId: taskData.id,
        body: {
          dayId,
          sectionId,
      ...
      updateTask(updateTaskVariables);
      onRequestClose();
    },
  });
